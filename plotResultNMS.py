...
plt.xlabel(u'置信度阈值threshold',fontproperties=zhfont)
plt.ylabel('mAP%')
plt.legend(loc=5,prop =zhfont)
# plt.show()
...
plt.xlabel('Nt',fontproperties=zhfont)
plt.ylabel('mAP%')
...
plt.xlabel('Sigma',fontproperties=zhfont)
plt.ylabel('mAP%')
